...
//     super(props);
//     this.state = {
//       currentPrice: StonkAPI.fetchStonkCurrentPriceAPI('GME', window.finnhubAPIKey),
//       bigPrice: 0
//     }
...
//   componentDidMount() {
//     this.setState({bigPrice: this.state.currentPrice})
//   }
...
//       time: this.props.intradayData.t[i],
//       price: this.props.intradayData.o[i],
//       // pc: this.props.intradayData.pc
//     })
//     const dottedLine = realData[0].o;
//     // const dottedLine = this.props.quote.pc;
...
//             <div className="chartHeader"> 
//               <div className="currentPrice">
//                 <h1>$<Odometer value={this.state.bigPrice}/></h1>
//               </div>
//               <div className="priceChanges">
//                 <div className="priceToday">
//                   <div className="priceTodayNumbers">
